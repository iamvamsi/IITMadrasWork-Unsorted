echo "#THIS IS THE DATA FOR THE OPERATION EXTRACT" >"EXTRACT"		#creates the file EXTRACT and writes the data. > implies writing the data
echo "#inputs		average_time ">>"EXTRACT"			#appends the data . >> is to append
...
do
	...
	do 	
		...
		./q 1 infile infile1				#after g++ -o q leftistheaps.cpp
...
echo $i"		"$avg >> "EXTRACT"			#append the data >> implies append
done		
